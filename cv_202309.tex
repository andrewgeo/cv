...
% MACROS
    ...
    \newcommand{\cvprofile}[5]{ %name,job,address,email,phone
        \begin{center}
            ...
            Blog: www.44digits.com
            $\cdot$\enspace
            LinkedIn: www.linkedin.com/in/andrewross44
        \end{center}
    }
...
% VARIABLES
    ...
    \newcommand{\CVcompany}{Wood Rodgers, Inc.}
...
GIS Engineer with over 9 years of experience building GIS and mapping applications.
Expert Python experience with spatial and data analysis libraries including GeoPandas, ArcPy.
