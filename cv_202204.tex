...
\tagged{GISCV}{
    \jobintro{
        Supported corporate web-based mapping application.  Collected, cleaned,
        verified, and consolidated geospatial data from dispirate sources.
        Managed spatial database.  Provided complex spatial analyses and
        visualizations for planners and administrators throughout company.
        Extensive use of python for geoprocessing, including geopandas, ArcPy, and Jupyter.
        }
    }

\begin{jobtasklist}
    \item Deployed automated spatial data workflow to consolidate dispirate
    geospatial data from partner organiations, incluinding cleaning, verification and upload into
    corpate mapping application.  Workflow processes over 6.5 million features per day.

    \item Developed standardized tools for processing and managing spatial for incorporation into 
    corporate spatial data platform.

    \item Deployed automated system to continuously monitor configuration of
    over 3000 layers in multiple mapping applications.
...
\tagged{GISCV}{
    \jobintro{
        ...
        collectded field-based data, conductded spatial data modeling and analysis. 
...
%                \\
    ...
    \begin{taggedblock}{GISCV}
        \begin{skillslist}
            GIS:& 
                ESRI ArcGIS Desktop \& ArcGIS Pro, Spatial Analyst, 3D Analyst,
                spatial data pipelines with Safe FME, Orthorectification, Lidar processing
                \\
            Python:& 
                Geoprocessing with ArcPy, geopandas, rasterio
                Data management, cleaning \& verification, 
                \\
             Databases:& 
                 Oracle spatial and PostgreSQL/PostGIS RDBMSs, SQL,
...
%                \\
            Customer service: &
                Engaged with technical and non-technical clients, and partners
                to identify data needs, plan data collection projects, and
