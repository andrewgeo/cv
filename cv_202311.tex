...
\begin{jobtasklist}
    ...
    \item Improved utilizatoin of corporate mapping platform by supporting users requests for 
...
Updates GIS programming, analytical functions, and related technologies
    (Internet/Intranet mapping, Databases/SDE)
