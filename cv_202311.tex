\documentclass[letterpaper]{article}
    \usepackage[top=0.75in,bottom=1in,left=1.1in,right=1.1in]{geometry}
    %\usepackage{fullpage}
...
\begin{jobtasklist}
    ...
    \item Engineered spatial data analysis tools in Python
            with Jupyter, GeoPands, ArcPy, and Scikit-Learn
            increasing to corporate data warehouse
    ...
    \item Pioneered and deployed containerized API Docker infrastructure to expand functionality of maps for individual
            projects and departments, consisting of 19 endpoints written in Pythan FastAPI, 
