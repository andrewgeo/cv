...
Expert Python knowledge developing spatial-data ETL pipelines with spatial and data analysis libraries including GeoPandas, ArcPy.
...
\begin{jobtasklist}
    ...
    \item Expanded utilizatoin of corporate mapping platform by supporting users requests for 
            extraction \& analysis of spatial data

    \item Built spatiatial data analysis tools in Python with Python, GeoPands, ArcPy, and Scikit-Learn
