...
\begin{jobtasklist}
    ...
    \item Worked with multiple departments to create a continuous monitoring system
            to ensure the stream of ridership data was uninterrupted

    \item Performed statistical and spatial analysis on ridership data for administrative
            and planning departments, preparing reports and summaries, directly supporting 
            management and planning of transit network

    \item Managed updates and integration of spatial data into corporate spatial data warehouse
