...
\begin{jobtasklist}
    ...
    \item Greatly improved speed and efficiency of GIS support staff by developing and deploying
        standardized workflows and tools for spatial data management and systems maintenance

    \item Expanded utilization of corporate mapping platform by supporting users requests for 
            extraction \& analysis of spatial data

    \item Built spatial data analysis tools in Python with Python, GeoPands, ArcPy, and Scikit-Learn

    \item Trained GIS staff to support corporate mapping platform ensuring their ability to 
            address database, map server and other system issues.

    \item Increased stability, staff time, efficiency of staff
    ...
    \item Reduced time to develop tools and services by
        ...
        corporate systems, comprising over 7000 lines of code.
    ...
    \item Simplified and decoupled system architecture by designing \& deploying
    ...
    \item Deployed standardized tools \& procedures for cleaning, consolidating, and updating spatial data.

    \item Established standards \& quality control for data entry procedures.
...
\begin{jobtasklist}
    ...
    \item Client align business needs 
    \item Provided business inights
    \item using python \& arc gis 
    \item Decision making
    \item Define cutomer needs and make recommendations
