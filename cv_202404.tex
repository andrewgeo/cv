...
%Highly motivated Data Engineer with over 9 years of experience designing, developing, and maintaining data pipelines and integrations. 
...
\iffalse
Are you proficient in GIS applications?
Yes, I am highly proficient in GIS applications. I possess expertise in industry-standard tools like ESRI ArcGIS Pro and QGIS, along with advanced skills in spatial data analysis using Python libraries like GeoPandas and Shapely. My experience includes designing and managing geospatial data pipelines, performing spatial analysis, and developing custom solutions using these technologies.

Do you have a strong understanding of and capability to use SQL and PostGres? *
Yes, I have a strong understanding of and capability to use SQL and PostGIS.  My experience includes managing PostgreSQL databases for spatial analysis and geostatistics, and writing functions and triggers.

Are you familiar with DevOps processes and procedures?
Yes, I am familiar with DevOps processes and procedures. In my role as a GIS Data Engineer at Congruex, I architected and managed containerized cloud API infrastructure using Python FastAPI on Azure, demonstrating proficiency in DevOps practices such as continuous integration and deployment.  Additionally I use Git daily for source code management and Azure DevOps for communication, managing tasks and sprints.

Are you experienced in data analytics and management?
Yes, I am experienced in data analytics and management. Throughout my 9 years as a GIS Data Engineer, I've developed and deployed targeted surveys, improved analysis turnaround by automating data processes, and managed spatial ETL pipelines processing vast amounts of data daily, showcasing my proficiency in data analytics and management across various projects and organizations.

Are you able to query data, troubleshoot data errors, and conduct synchronization replication?
Yes, I am able to query data, troubleshoot data errors, and conduct synchronization replication. In my role at Congruex, I managed spatial ETL pipelines and conducted data cleaning and verification, ensuring accurate and reliable data processing. Additionally, my experience includes integrating spatial data into corporate spatial data warehouses and conducting analyses, demonstrating proficiency in troubleshooting data errors and conducting synchronization replication processes.
