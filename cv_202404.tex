    ...
    \begin{taggedblock}{GISCV}
        \begin{skillslist}
            GIS applications:&
                ...
                Proficient in \impt{Spatial modelling} to derrive relationships \& patterns on the ground
...
%                Data Architecture, data modeling, warehousing and analytics \linebreak
            ...
            Programming \& scripting:&
                Geoprocessing with \impt{Python} spatial libraries including ArcPy, GeoPandas, Shapely \linebreak
