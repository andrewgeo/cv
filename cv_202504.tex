...
\begin{jobtasklist}
    ...
    \item  Enhanced the management and efficiency of spatial data ETL pipelines,
            ...
            by developing custom monitoring and recovery tools using Python and FME.
    \item  Significantly reduced ETL process development time, leading to faster implementation cycles,
    ...
    \item  Enabled high-volume geospatial data transfer, successfully moving hundreds of thousands of
            features daily from the core application database to ArcGIS Online (AGOL) through the management
            and optimization of application APIs.
\end{jobtasklist}
