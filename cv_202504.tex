...
\tagged{GISCV}{
{\JobTitle} with over 5 years of expertise in \impt{geospatial data infrastructure} 
supporting analytical workflows across organizations.
Expert level of Python and SQL, geospatial data formats and PostGIS, AGOL and other geospatial databases.
Proven experience working with current versions of QGIS and ArcGIS Pro.
}
...
\begin{jobtasklist}
    \item Modernized and scaled production-grade geospatial data pipelines moving millions of daily spatial records; 
            implemented automated data quality monitoring and testing infrastructure to guarantee high reliability 
            for real-time analytics workflows.
    \item Developed Python library to automate the testing of spatial data pipelines,
            utilizing ESRI REST endpoints,
            resulting in continuous standardized testing of pipelines and downstream integrations.
\end{jobtasklist}
...
\begin{jobtasklist}
    ...
    \item Designed and implemented robust spatial ETL pipelines utilizing Safe Software FME Server,
            Python, and ArcPy. 
            Integrated diverse geospatial datasets to streamline data flow,
...
%            corporate mapping platform comprising more than 7000 lines of code
    \item Architected containerized spatial ETL pipelines on Azure using Python and Airflow, 
            \impt{processing 13M+ daily features} with automated data quality checks, 
            ensuring reliable geospatial data for real-time analytics and internal dashboards.
