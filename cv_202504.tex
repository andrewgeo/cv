...
\tagged{GISCV}{
Over 10 years of experience developing geospatial analytical solutions and robust
\impt{spatial data pipelines}.
...
%                \\
            Programming \& scripting:&
                Advanced \impt{Python} programming: ArcPy, GeoPandas, NumPy, Scikit-learn\linebreak
...
\begin{jobtasklist}
    ...
    \item  Enhanced the management and efficiency of spatial data ETL pipelines,
            improving data flow reliability and reducing manual intervention,
            by developing custom monitoring and recovery tools using Python and FME.
    \item  Reduced ETL process development time and accelerated implementation cycles
