...
\tagged{GISCV}{
{\JobTitle} with over 9 years of experience developing geospatial analytical solutions and spatial data pipelines.
Skilled at consolidating large numbers of disparate datasets, establishing data quality, metadata, and documentation standards supporting data governance policies.
Proficient in leveraging \impt{cloud platforms (AWS, Azure)} and containerization technologies (Docker) to build scalable 
web applications and APIs for delivering \impt{geospatial data at scale}.
Experience with machine learning models through coursework and projects.
