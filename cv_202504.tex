...
\tagged{GISCV}{
Highly experienced {\JobTitle} with over 10 years of expertise in architecting and deploying
robust geospatial data pipelines and ETL processes.
...
Demonstrated ability to develop custom mapping applications, APIs, and perform advanced spatial analysis using Python and ArcPy.
...
\begin{jobtasklist}
    ...
    \item Enabled high-volume geospatial data transfer, successfully moving hundreds of thousands of features daily 
            from the core application database to ArcGIS Online (AGOL) through the management and optimization of application APIs.
