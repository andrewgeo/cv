...
\begin{jobtasklist}
    ...
    \item  Enabled high-volume geospatial data transfer, successfully moving hundreds of thousands of
            features daily from the core application database to ArcGIS Online (AGOL) through API
...
\begin{jobtasklist}
    \tagged{DATACV}{
        \item Enhanced transit network decision-making by delivering
                \impt{statistical and spatial analysis}
                reports and summaries on ridership data, enabling more informed
