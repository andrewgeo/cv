...
\tagged{GISCV}{
Over 9 years of experience designing and deploying scalable geospatial solutions, 
including data pipelines, ETL Processes, and custom mapping applications.
...
\begin{jobtasklist}
    ...
    \item  Enabled high-volume geospatial data transfer, successfully moving hundreds of thousands of
            ...
            through the management and optimization of application APIs.
\end{jobtasklist}
