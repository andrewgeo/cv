...
\begin{jobtasklist}
    ...
    \item Designed and implemented robust \impt{spatial ETL pipelines utilizing Safe Software FME}, Python, and ArcPy, 
            significantly enhancing data flow reliability and reducing manual intervention for critical GIS applications.
