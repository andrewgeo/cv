...
\tagged{GISCV}{
Experienced {\JobTitle} with over 10 years of experience in
developing and deploying GIS applications, spatial analyses, spatial data pipelines, and APIs. 
Proven ability to utilize Python and ArcPy to create custom mapping applications and dashboards 
that empower decision-makers in managing real-world assets. 
...
\begin{jobtasklist}
    ...
    \item Improved the management and efficiency of spatial data ETL pipelines by developing 
        custom monitoring and recovery tools in Python and FME.

    \item Reduced ETL process development time by creating a Python library that simplifies 
        access to corporate data sources and systems.
