...
\tagged{GISCV}{
{\JobTitle} with over 10 years of expertise in \impt{developing geospatial analytical} solutions and robust spatial data pipelines.
Expertise developing ESRI geospatial database schemas, designing and implementing ESRI Enterprise Geodatabases.
Proven technical expertise in GIS concepts, analysis, and tools, ESRI ArcGIS Enterprise and SDE.
Current experience with ESRI's Utility Network for a large electric and gas utility.
...
%Senior Data Engineer with over 10 years of expertise architecting and maintaining
%\impt{scalable data pipelines for geospatial data products} using Python, SQL, and cloud platforms. 
%I specialize in optimizing spatial data storage and processes with \impt{PostGIS, ArcPy and GeoPandas}, 
%and operationalizing data solutions with automated quality checks, 
%detailed documentation, and containerized orchestration. 
%Extensive experience collaborating with cross-functional teams to translate complex
%requirements into full-service, reliable data solutions.  
}

\iffalse
SQL, Python, DBT, Utilize geospatial data tools to optimize and normalize spatial data storage, 
run spatial queries and processes to power analysis and data products
PostGIS, ArcGIS/ArcPy, QGIS, GeoPandas, etc.) 
Design, create, refine, and maintain data processes and pipelines 
used for modeling, analysis, and reporting using SQL PostgreSQL
Python and pipeline and transformation tools like Airflow and dbt
...
%                Apache Airflow workflow Orchestration: DAG creation and deployment \linebreak
    ...
    \begin{taggedblock}{GISCV}
        \begin{skillslist}
            GIS Applications:&
                QGIS, ESRI ArcGIS Pro \linebreak
...
\begin{jobtasklist}
    \item Overseeing the spatial data pipelines at a major electric utility moving
    ...
    \item Created Python library to automate the testing of spatial data pipelines
            resulting in faster testing and faster identification of pipeline issues,
            utilizing ESRI REST endpoints.
...
\begin{jobtasklist}
    ...
    \item Designed and implemented robust spatial ETL pipelines utilizing Safe Software FME Server,
            Python, and ArcPy. 
...
%            improved \impt{data accessibility for critical infrastructure design}.
    \item Led data platform development by deploying a \impt{scalable cloud-based API infrastructure}
            (Python/FastAPI on Azure), serving as the foundation for 19
            fully-cataloged spatial data services to enhance data accessibility and
            data governance for critical infrastructure design.
...
%            corporate mapping platform comprising more than 7000 lines of code
    \item Designed and implemented an automated, containerized spatial ETL pipeline on Azure,
            ...
            applications built with Python, Airflow, and dbt.
