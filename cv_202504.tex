...
%Highly skilled in professional, organizational, written, and verbal communication.
%, enabling effective collaboration across multidisciplinary teams. 
Adept at problem-solving, time management, and detail-oriented execution, ensuring projects meet client needs and deadlines.
%Combines self-initiative and self-motivation with a strong ability to work
%independently or as part of a team, delivering reliable and ethical geospatial solutions.
...
primarily reviewing geospatial data for accuracy and quality issues
supporting QA
finalization of customer product data
feeding back on Geospatial related bugs, customer issues
collaborating with the engineering team on GIS features and implementation
familiar with GitHub, and tools such as Slack, Notion, Google Suite.
written and verbal English communications skills are excellent
and you have empathy and understanding of different roles in the company
manage your own time effectively, across multiple projects and occasionally under pressure, able to prioritize short and long term activities with a strategic approach
strong attention to detail
creative and curious
well-organized, keeping many files in the right places and clear documentation up-to-date
talk to software engineers and data engineers.
Teamwork is at your core
your work is thorough, and you pay attention to both the small details and the larger picture
quickly adapt to new working practices and technologies
Experience working with GIS data in public or private utility.
Experience with Geospatial software such as QGIS.
...
%    \item Designed and implemented robust spatial ETL pipelines utilizing Safe Software FME Server, Python, and ArcPy,
%            significantly \impt{enhancing data flow reliability} and reducing manual intervention for critical GIS applications.
