...
%                \\
            Programming \& Scripting:&
                ...
                \impt{SQL}: spatial queries, stored procedures, and functions \linebreak
%                Experience with \impt{machine learning} with PyTorch \linebreak
                ETL Pipelines with dbt, Python, FME \linebreak
...
\begin{jobtasklist}
    \item Maintain and monitor spatial data pipelines moving
    ...
    \item Accomplished enhanced reliability of the spatial ETL process the creation of automated 
            \impt{Python test suites} that systematically checked for schema compliance, 
            spatial reference accuracy, and data completeness.
