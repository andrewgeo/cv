...
designing, building, and maintaining data pipelines and integrations with big data systems.
\impt{Proficient in using Python and SQL} to perform complex data transformations
with large data processing to extract actionable insights from complex datasets.
Experienced with tackling complex projects
leveraging multiple internal and external geospatial datasets.
Effective communication skills for \impt{multi-disciplinary collaboration} and end-user support.
}

\iffalse
Design, build, and maintain the data pipelines
integrations between our client’s data warehouse
Leverage multiple internal and external geospatial datasets
Contribute to the data and tooling strategy
Collaborate with these teams to streamline our shared CRM's architecture, performance, and usability
Identify and evaluate potential external geographic-centric data sources
Collaborate with external data providers
using SQL to perform complex data transformations
Experience with geospatial data, software, sources, and practical applications
Python for geospatial applications and leveraging Python libraries
breaking down complex technical concepts into common language
bridge between technical and departmental stakeholders
working with complex and big data systems
meet business goals
...
\begin{jobtasklist}
    ...
    \item Designed and implemented robust spatial ETL pipelines utilizing Safe Software FME Server,
            Python, and ArcPy, integrating diverse geospatial datasets
...
%            corporate mapping platform comprising more than 7000 lines of code
    \item Designed and implemented an automated, containerized spatial ETL pipeline on Azure,
            ...
            to ensure data integrity for complex scientific applications and external interfaces.
    \item Designed and architected a high-volume, automated, containerized
            spatial ETL platform on Azure, leveraging custom algorithms for robust
            data quality assurance and automated validation, \impt{processing over 13
            million geospatial features daily} to ensure data integrity and
            compliance.
