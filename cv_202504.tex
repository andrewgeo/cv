...
\tagged{GISCV}{
{\JobTitle} with 10+ years of experience architecting and deploying robust geospatial data pipelines and ETL processes.
Skilled in establishing data quality frameworks and collaborating with stakeholders to define requirements and enforce governance.
...
for transforming \impt{geospatial data at scale}.
...
\begin{jobtasklist}
    ...
    % process management
    % cleaning
    % spatial admin library - most common functions
    %• Developed a workspace to automatically restart failed FME jobs, reducing manual intervention and ensuring smoother job continuity.
    %• Created a workspace to rebuild the spatial indexes of AGOL Feature servers, enhancing performance and maintaining data integrity.
    %• Designed a workspace to count and compare features between the Pcubed database and AGOL, streamlining data validation and ensuring consistency.
    \item Managed and optimized spatial data ETL pipelines using Python and FME, enhancing data flow
            reliability and reducing manual intervention, contributing to efficient data delivery for critical operational needs.
    \item Streamlined ETL process development by creating a Python library for efficient access to application data sources,
            resulting in faster implementation cycles and improved responsiveness to project requirements.
    \item Managed and optimized application APIs to enable high-volume geospatial data transfer
            (hundreds of thousands of features daily) to ArcGIS Online (AGOL),
            supporting data accessibility and visualization for stakeholders.
\end{jobtasklist}
%------------------ Congruex ------------------%
\tagged{DATACV}{
    \employer
...
\begin{jobtasklist}
    % Accomplished X as measured by Y by doing Z
    \item Developed and deployed a cloud-based API infrastructure
            (\impt{Python/FastAPI on Azure}) delivering 19 geospatial analysis, reporting,
            and data management services, enhancing the mapping system's capabilities
            and providing critical data insights to various departments.
...
%
    \item Developed and implemented an automated data cleaning and quality assurance spatial ETL pipeline
...
\begin{jobtasklist}
    \tagged{DATACV}{
        \item Performed \impt{statistical and spatial analysis} on ridership data for administrative
