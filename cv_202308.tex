...
\tagged{GISCV}{
    \jobintro{
        Managed corporate mapping platform by developing spatial data pipelines and
        tools to clean and consolidate data from disparate sources. Developed spatial
        analyses and visualizations using Python for geoprocessing, including
        geopandas, ArcPy, and ScikitLearn. Specifically: 
        }
    }

\begin{jobtasklist}
    \item Created and maintained a
        core geospatial Python library supporting APIs and standard tools for efficient
        management of the mapping applications, comprising over 7000 lines of code.
    \item Deployed a Python-based ETL workflow to consolidate geospatial data
        ...
        day.
    \item Implemented API infrastructure and created 17 endpoints in
        Python to support geospatial analysis, along with a continuous testing
        suite.
    \item Developed tools to monitor the health \& performance of mapping
        applications, checking loading times, availability, and performing
...
\tagged{GISCV}{
    \jobintro{
        Created, managed, and analyzed targeted surveys, aligning data
        collection to client needs. Utilized Python for data munging, process
