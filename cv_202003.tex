\documentclass[letterpaper]{article}
    ...
    \renewcommand{\CVjobTitle}{ArcGIS Pro Analyst}
...
\tagged{GISCV}{
    ...
    collecting field-based data, spatial data analysis and modeling. 
    Working closely with clients to develop their
    reqirements and spatial data needs.  
    Created maps and web-based spatial tools.
...
\tagged{GISCV}{
    ...
    Managed updates and integration of new data into corporate spatial data
    warehouse.
    }
