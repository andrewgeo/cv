...
% VARIABLES
    ...
    \renewcommand{\CVjobTitle}{Data QA Analyst}
...
\tagged{DATACV}{
    ...
    Developed tools and utilities in Python and SQL to manage and report on data
...
%                Python, R, Excel, and 
%                creating data presentations and exploratory dashboards with Tableau
%                \\
            Databases: & 
