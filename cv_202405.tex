...
Advanced knowledge of Python, and concomitant data-processing libraries, 
...
\begin{jobtasklist}
    \tagged{DATACV}{
        ...
        \item Managed updates and integration of economic, demographic and transportation data into the 
