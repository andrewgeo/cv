...
% VARIABLES
    ...
    \newcommand{\CVjobTitle}{Data Engineer}
    \newcommand{\CVcompany}{LandGate}
...
Highly motivated {\CVjobTitle} with over 9 years of experience in Python, SQL, and data processing.
Demonstrated professional experience building data pipelines and developing REST APIs.
Proven ability to work independently while collaborating effectively with a team to design,
    ...
    \begin{taggedblock}{DATACV}
        \begin{skillslist}
            Python:&
                ...
                Develop ETL pipelines \linebreak
                ...
                \\
            SQL:&
                PostgreSQL - complex SQL queries, stored procedures, and functions \linebreak
                \\
%            Data analysis: &
...
%
    ...
    \item Dramatically improved speed and efficiency of support staff tasks by
            ...
            for data management, quality control, and system maintenance
