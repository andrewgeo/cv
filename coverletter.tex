\documentclass[letterpaper]{article}
    ...
    %    CVphone
    \input _private.tex
    %\newcommand{\CVjobTitle}{Business System Analyst}
...
%plotters, along with GPS units.  
%I have worked with and consolidated data in a
%wide range of formats.  
%I have also worked with sensitive
...
%, and \impt{produce high-quality maps} and posters.
